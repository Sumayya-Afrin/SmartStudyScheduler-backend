            ...
            <View style={styles.centeredContent}>
              ...
              <View
                style={[
                  styles.infoBox,
                  {
                    backgroundColor: C.isDark ? 'rgba(200,245,102,0.05)' : 'rgba(92,158,0,0.05)',
                    borderColor: C.isDark ? 'rgba(200,245,102,0.12)' : 'rgba(92,158,0,0.12)',
                  },
                ]}
              >
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
              >
                <Text style={[styles.submitText, { color: accentFg }]}>Back to Log In →</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => setSent(false)} style={styles.retryRow}>
            ...
            <>
              ...
              >
                {isLoading ? (
                  ...
                  <Text style={[styles.submitText, { color: accentFg }]}>Send Reset Link →</Text>
                )}
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // Card lives in a flex region that pushes footer to the bottom
  pageBody: {
    flex: 1,
    alignItems: 'center',
